 ...
 *
 *  This variable can be set to the following values:
 *    "0" or "nearest" - Nearest pixel sampling,最近像素采样
 *    "1" or "linear"  - Linear filtering (supported by OpenGL and Direct3D),线性过滤（OpenGL和Direct3D支持）
 *    "2" or "best"    - Currently this is the same as "linear",目前这与“线性”相同
 *
 *  By default nearest pixel sampling is used,默认情况下，使用最近的像素采样
 */
